...
export const APP_PREVIOUS_VERSION = '1.29.0'
...
export const LOG_ANALYTICS_ENGINE = 'collector-reliability-v1.30.0'
export const LOG_UI_REVISION = 'collector-reliability-ui-v1.30.0'
