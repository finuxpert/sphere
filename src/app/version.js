...
export const APP_PREVIOUS_VERSION = '1.32.1'
...
export const LOG_ANALYTICS_ENGINE = 'availability-observation-v1.33.0'
export const LOG_UI_REVISION = 'availability-observation-ui-v1.33.0'
