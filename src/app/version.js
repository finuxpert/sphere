...
export const APP_PREVIOUS_VERSION = '1.22.2'
...
export const LOG_ANALYTICS_ENGINE = 'evidence-correlation-v1.21.1'
export const LOG_UI_REVISION = 'operator-density-hotfix-v1.22.3'
