...
export const APP_PREVIOUS_VERSION = '1.32.0'
...
export const LOG_ANALYTICS_ENGINE = 'operator-clarity-v1.32.1'
export const LOG_UI_REVISION = 'operator-clarity-ui-v1.32.1'
