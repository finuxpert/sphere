...
export const APP_PREVIOUS_VERSION = '1.20.7'
...
export const LOG_ANALYTICS_ENGINE = 'evidence-correlation-v1.21.0'
export const LOG_UI_REVISION = 'operational-clarity-ui-freeze-v1.20.7'
