...
export const APP_VERSION = '1.23.10'
export const APP_PREVIOUS_VERSION = '1.23.9'
...
export const LOG_ANALYTICS_ENGINE = 'operational-evidence-v1.23.0'
export const LOG_UI_REVISION = 'selected-workload-width-ownership-v1.23.10'
