...
export const APP_PREVIOUS_VERSION = '1.23.14'
...
export const LOG_ANALYTICS_ENGINE = 'historical-performance-explorer-v1.24.0'
export const LOG_UI_REVISION = 'historical-performance-explorer-v1.24.0'
