...
export const APP_PREVIOUS_VERSION = '1.30.0'
...
export const LOG_ANALYTICS_ENGINE = 'collector-observability-v1.31.0'
export const LOG_UI_REVISION = 'self-healing-ops-ui-v1.31.0'
