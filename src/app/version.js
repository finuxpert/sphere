...
export const APP_PREVIOUS_VERSION = '1.24.1'
...
export const LOG_ANALYTICS_ENGINE = 'historical-performance-explorer-v1.24.2'
export const LOG_UI_REVISION = 'sm37-verification-context-v1.24.2'
